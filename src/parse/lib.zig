...
pub const SectionStart = event.SectionStart;
pub const TableStart = event.TableStart;
pub const TableRecordStart = event.TableRecordStart;
pub const BlockStart = event.BlockStart;
pub const ClassStart = event.ClassStart;
pub const EntityStart = event.EntityStart;
pub const ObjectStart = event.ObjectStart;
pub const End = event.End;
