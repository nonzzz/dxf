...
pub fn read(parser: *parse.Parser, start: parse.EntityStart) common.ReadError!Attrib {
...
fn apply(self: *Attrib, token: tokenizer.Tokenizer.Token) common.ReadError!void {
    switch (token.code) {
